        ...
        <div class="result-card slide-up" v-if="result">
          ...
          <div class="mb-8 fade-in" style="animation-delay: 0.3s">
            <div class="relative inline-block">
              ...
              <div
                class="absolute inset-0 bg-gradient-to-r from-red-500/20 to-red-600/20 rounded-2xl blur-xl -z-10 transform scale-110"
              ></div>
            </div>
          </div>
          ...
          <div
            class="mt-8 pt-6 border-t border-gray-200 fade-in"
